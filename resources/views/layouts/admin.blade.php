...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-gray-50-100">       
        ...
        {{-- Mostrar Sweet Alert (Mensajes de éxito) --}}
        @if (session('swal'))
            <script>
        ...
        {{-- Confirmar eliminación (A prueba de Livewire) --}}
        <script>
            document.addEventListener('submit', function(event) {
                // Revisamos si el formulario que se está enviando tiene la clase 'delete-form'
