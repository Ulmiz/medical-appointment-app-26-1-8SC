...
class RoleController extends Controller
{
     ...
     */
    public function update(Request $request, Role $role) // <-- Cambiado a Role $role
    {
    ...
    } // <-- Se eliminó la llave extra que estaba aquí abajo

    /**
     * Remove the specified resource from storage.
     */
    public function destroy(Role $role) // <-- Cambiado a Role $role
    {
        //Borrar el elemento
        $role->delete();
